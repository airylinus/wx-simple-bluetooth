...
export const getAppBLEManager = new class extends LBlueToothManager {
    constructor() {
        ...
        //setFilter详情见父类
        super.setFilter({
            services: ['6E400001-B5A3-F393-E0A9-E50E24DCCA9E'],//必填
            targetServiceArray: [{
                serviceId: '6E400001-B5A3-F393-E0A9-E50E24DCCA9E',//必填
                writeCharacteristicId: '6E400002-B5A3-F393-E0A9-E50E24DCCA9E',//必填
                notifyCharacteristicId: '6E400003-B5A3-F393-E0A9-E50E24DCCA9E',//必填
                readCharacteristicId: '',//非必填   
            }],
            targetDeviceName: 'mpy-uart',//非必填，在判断时是用String.prototype.includes()函数来处理的，所以targetDeviceName不必是全称
